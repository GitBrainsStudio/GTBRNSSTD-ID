...
{   
    ...
    {
        return of<Client>(new Client('asdasd', 'asdasd', 'asdasd', 'asdasdasd', []))
    }
    ...
    getAll() : Observable<Client[]>
    {
        ...
        let fakeClients:Client[] = [
            new Client('C08CA4CE990F55DAE05400E000A92421', 'Program 1', 'x', 'x', fakeRoles2),
            new Client('C08CA4CE990F55DAE05400E000A92422', 'Program 2', 'x', 'x', fakeRoles2),
            new Client('C08CA4CE990F55DAE05400E000A92423', 'Program 3', 'x', 'x', fakeRoles2),
            new Client('C08CA4CE990F55DAE05400E000A92424', 'Program 4', 'x', 'x', fakeRoles2),
            new Client('C08CA4CE990F55DAE05400E000A92425', 'Program 5', 'x', 'x', fakeRoles1),
            new Client('C08CA4CE990F55DAE05400E000A92426', 'Program 6', 'x', 'x', fakeRoles2),
        ]
        return of<Client[]>(
            fakeClients
            ).pipe(delay(800));
